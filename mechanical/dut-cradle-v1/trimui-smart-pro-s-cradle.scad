/*
 * PocketForge reusable DUT cradle — TrimUI Smart Pro S profile
 *
 * Coordinates: X left-to-right, Y bottom-to-top, Z toward the webcam; mm.
 *
 * Examples:
 *   openscad -o plate.stl -D 'PART="plate"' trimui-smart-pro-s-cradle.scad
 *   openscad -o hook.stl  -D 'PART="hook"'  trimui-smart-pro-s-cradle.scad
 *
