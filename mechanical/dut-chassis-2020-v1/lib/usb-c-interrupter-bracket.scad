/*
 * Production rail bracket for the owner's physically accepted dual USB-C interrupter.
 *
 ...
 *
 * This preserves the owner-accepted physical-fit geometry. The photographed face was
 * measured as 20.09 x 6.59 mm with two nominal 2 mm holes on 16 mm centres.
 * One interrupter consists of two of those port boards; the accepted holder
 ...
 * after including the 2 mm hole, so the holder centres the hole row on the
