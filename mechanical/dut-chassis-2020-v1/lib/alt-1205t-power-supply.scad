...
module alt1205t_contract() {
    ...
    assert(alt1205t_upper_right_slot_top_tangent() == 2.94, "ALT-1205T corrected upper slot inset changed");
            ...
            color([0.68, 0.70, 0.72])
                linear_extrude(height = 1.2)
                    difference() {
                            ...
                            translate([110 - 3.5, 0]) square([3.5, alt1205t_label_top_right_slot_height()]);
                    }
        } else if (view == "side") {
